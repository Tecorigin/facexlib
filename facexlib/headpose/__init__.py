...
def init_headpose_model(model_name, half=False, device='sdaa', model_rootpath=None):
    ...
    load_net = torch.load(model_path, map_location=lambda storage, loc: storage, weights_only=False)['params']
